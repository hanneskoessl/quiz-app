...
urlpatterns = [
    ...
    path("quizzes/category/<int:catagory_id>/", views.quiz_category, name="quiz_category"),
    ...
    path("quiz/<int:quiz_id>/students_stats/", views.students_quiz_stats, name="students_quiz_stats"),
]